...
<body>
    ...
    <div class="lienhe" style="display: flex;margin-left: 10%;height: auto;margin-bottom: 30px;" >
       ...
       $(document).ready(function(){
        ...
        $('.send-comment').click(function(){
            ...
            $.ajax({
                ...
                success:function(data){
                   $('#notify_comment').html('<span style="color:green" class"text text-success">Thêm bình luận thành công,đang chờ phê duyệt</span>');
                    load_comment();
