...
<div class="table-agile-info">
  <div class="panel panel-default">
    <div class="panel-heading" style="font-size: 18px;font-weight: bold;text-align: center;">
      CHI TIẾT ĐƠN HÀNG
    </div>
      ...
      <table class="table table-striped b-t b-light">
        ...
        <tbody>
          ...
          <tr class="color_qty_{{$details->product_id}}">
            ...
            <td>@if($details->product_coupon != '0')
            ...
            <td colspan="2">
                ...
                @if($coupon_condition == 1)
                    @php
                        ...
                        echo 'Tổng được giảm: ' . number_format($total_percent_coupon, 0, ',', '.').' đồng'. '</br>';
                        $total_coupon = $total - $total_percent_coupon + $details->product_feeship;
                    @endphp
                @else
                    @php
                        echo 'Tổng được giảm: ' . number_format($coupon_number, 0, ',', '.').' đồng'.'</br>';
