                    ...
                    <div class="signup-form"><!--sign up form-->
                        ...
                        <form action="{{URL::to('/add-user')}}" method="POST">
                            ...
                            <div class="form-group">
                                <input type="text" class="ggg" name="user_name" placeholder="Họ tên">
                                @error('user_name')
                                    <span style="color:red;" class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="form-group">
                                <input type="text" class="ggg" name="user_email" placeholder="Email">
                                @error('user_email')
                                    <span style="color:red;" class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="form-group">
                                <input type="text" class="ggg" name="user_phone" placeholder="Số điện thoại">
                                @error('user_phone')
                                    <span style="color:red;" class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="form-group">
                                <input type="text" class="ggg" name="user_address" placeholder="Địa chỉ">
                                @error('user_address')
                                    <span style="color:red;" class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="form-group">
                                <input type="password" class="ggg" name="user_password" placeholder="Mật khẩu">
                                @error('user_password')
                                    <span style="color:red;" class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="form-group">
                                <input type="password" class="ggg" name="user_password_confirmation" placeholder="Nhập lại mật khẩu">
