...
<hr>
        <div style="margin-left:10%;margin-bottom: 50px;">
            <p style="color:red;font-size: 16px;">CHÍNH SÁCH ĐỀN BÙ</p>
            <p style="font-style:italic;font-size: 12px;"><i class="fa fa-calendar" aria-hidden="true"></i> Đăng ngày 15-10-2020</p>
            <p style="margin-left:50px">Để đảm bảo quyền lợi cho khách hàng hiện nay, May Boutique triển khai chính sách đền bù như sau:</p>
            <p style="margin-left:50px">Toàn bộ khách hàng hiện nay của May Boutique sẽ được tăng quy đổi điểm tích lũy dựa trên giá trị đã mua hàng theo các hạng mức sau</p>
            <style type="text/css">
                table {
                    width: 50%;
            ...
            <table>
                <tr>
                    <th>Tổng giá trị mua hàng đã tích lũy</th>
                    <th>Mức quy đổi</th>
                </tr>
                <tr>
                    <td>Dưới 500.000</td>
                 ...
                 <tr>
                    <td>500.000 - dưới 1.000.000</td>
                    <td>100.000 điểm + 1.000.000 Doanh số tích</td>
                </tr>
                 <tr>
                    <td>1.000.000 - dưới 1.500.000</td>
                    <td>125.000 + 1.000.000 Doanh số tích</td>
                </tr>
                 <tr>
                    <td>1.500.000 - dưới 2.000.000</td>
                    <td>150.000 + 1.000.000 Doanh số tích</td>
                </tr>
                 <tr>
                    <td>2.000.000 - dưới 2.500.000</td>
                    <td>175.000 + 1.000.000 Doanh số tích</td>
                </tr>
                 <tr>
                    <td>2.500.000 - dưới 3.000.000</td>
                    <td>200.000 + 1.000.000 Doanh số tích</td>
                </tr>
                 <tr>
                    <td>3.000.000 - dưới 3.500.000</td>
                    <td>225.000 + 1.000.000 Doanh số tích</td>
                </tr>
                 <tr>
                    <td>3.500.000 - dưới 4.000.000</td>
                    <td>250.000 + 1.000.000 Doanh số tích</td>
                </tr>
                 <tr>
                    <td>4.000.000 - dưới 4.500.000</td>
                    <td>275.000 + 1.000.000 Doanh số tích</td>
                </tr>
                 <tr>
                    <td>4.500.000 - dưới 5.000.000</td>
                    <td>300.000 + 1.000.000 Doanh số tích</td>
                </tr>
                 <tr>
                    <td>5.000.000 - dưới 10.000.000</td>
                    <td>6% + 1.000.000 Doanh số tích</td>
                </tr>
                 <tr>
                    <td>10.000.000 - dưới 20.000.000</td>
                    <td>8% + 1.000.000 Doanh số tích</td>
                </tr>
                 <tr>
                    <td>Từ 20.000.000 trở lên</td>
                    <td>10% + 1.000.000 Doanh số tích</td>
                </tr>
            </table>
            <p>Từ ngày 18/06 - 18/07/2020, toàn bộ khách hàng đã có điểm tích lũy quy đổi thành công sẽ được sử dụng để thanh toán khi mua hàng tại May Boutique, với chiết khấu vào tổng giá trị hóa đơn không quá 10%.</p>
        </div>
