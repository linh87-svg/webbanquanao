...
<hr>
        <div style="margin-left:10%;margin-bottom: 50px;">
            <p style="color:red;font-size: 16px;">CHÍNH SÁCH ĐỔI TRẢ</p>
            <p style="font-style:italic;font-size: 12px;"><i class="fa fa-calendar" aria-hidden="true"></i> Đăng ngày 31-07-2020</p>
          <p><b>1.CHÍNH SÁCH ĐỔI/TRẢ</b></p>
